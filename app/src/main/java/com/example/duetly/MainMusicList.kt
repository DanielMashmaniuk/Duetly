        ...
        plAdapter = PlaylistListAdapter(requireContext(), list,
            {
                ...
                deletePl.setOnClickListener{
                    setButtonAnimation(deletePl,1.2f)
                ...
                namePl.setOnEditorActionListener { v, actionId, event ->
                    if (
                        ...
                        isEditPl = false
                        dbHelper.renamePl(plId,namePl.text.toString())
                        renamePl.setImageDrawable(ContextCompat.getDrawable(requireContext(), R.drawable.rename_svgrepo_com))
                        true
                    } else {
                        false
                    }
